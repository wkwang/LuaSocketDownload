--[[
    ...
    Example:
    local _downloader = LuaSocketDownLoader.new()
...
local LuaSocketDownLoader = class("LuaSocketDownLoader")
local socket = require("socket")

LuaSocketDownLoader.EVENT_PROGRESS = "EVENT_PROGRESS"
LuaSocketDownLoader.EVENT_COMPLETE = "EVENT_COMPLETE"
LuaSocketDownLoader.EVENT_ERROR = "EVENT_ERROR"

function LuaSocketDownLoader:ctor(options)
...
-- add url
function LuaSocketDownLoader:addUrl(url)
    table.insert(self._urlsList, {url = url, current = 0, total = 1, percent = 0, pos = nil})
end

-- add callback
function LuaSocketDownLoader:addCallback(callback)
...
function LuaSocketDownLoader:_dispatch(event, params)
...
function LuaSocketDownLoader:_closedCurrent()
...
function LuaSocketDownLoader:loopHandler( ... )
...
function LuaSocketDownLoader:_downloadByUrl()
...
function LuaSocketDownLoader:_receiveHandler()
